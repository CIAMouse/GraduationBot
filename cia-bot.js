function MessageHandler(context, event) {
    ...
    if(event.message == "[Graduation_Date] kmsfruit") {
    ...
    if(event.message == "[Graduation_Date] nexdrq_yt") {
    ...
    if(event.message == "[Graduation_Date] xxheyitznaomixx") {
    ...
    if(event.message == "[Graduation_Date] Xxsniper___"){
        context.sendResponse('>*Trainee Name:* Xxsniper___' + '\n\n>*Date Added:* Mon Jan 02, 2017' + '\n\n>*Predicted Graduation:* Mon Jan 23, 2017' + '\n\n>*Extended Date:* Mon Feb 13, 2017' + '\n\n_*The date shown is not final and may change at anytime depending on the situation.*_');
    }
    if(event.message == "[Graduation_Date] tbnrmeg") {
    ...
    if(event.message == "[Graduation_Date] bouncyjeffer"){
